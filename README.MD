...
This repo is a partial single thread wrapper for JoltPhysics physics engine.

**Please notice**. Currently, this is not a completely wrapper for JoltPhysics, and it only supports single-threading.
