...
const LAYER_STATIC_MASK: u32 =
    bit(PHY_LAYER_DYNAMIC) | bit(PHY_LAYER_BODY_PLAYER) | bit(PHY_LAYER_BODY_ALLY) | bit(PHT_LAYER_BODY_ENEMY);
const LAYER_DYNAMIC_MASK: u32 =
    bit(PHY_LAYER_STATIC) | bit(PHY_LAYER_BODY_PLAYER) | bit(PHY_LAYER_BODY_ALLY) | bit(PHT_LAYER_BODY_ENEMY);
...
const LAYER_BODY_ENEMY_MASK: u32 =
    bit(PHY_LAYER_STATIC) | bit(PHY_LAYER_DYNAMIC) | bit(PHY_LAYER_BODY_PLAYER) | bit(PHY_LAYER_BODY_ALLY);
